...
use Lemuria\Exceptions\ContentTooLongException;
use Lemuria\Exceptions\InvalidTokenException;
use Lemuria\Exceptions\NoPermissionsException;
use Lemuria\Exceptions\NotFoundException;
use Lemuria\Exceptions\RequestFailedException;
use Exception;
...
class Http
{
    ...
    /**
     * Current Lemuria HTTP API version.
     *
     * @var string
     */
    ...
    /**
     * Lemuria API base URL.
     *
     * @var string
     */
    public const BASE_URL = 'https://lemuria.valzargaming.com/api/v'.self::HTTP_API_VERSION;
        ...
        switch ($response->getStatusCode()) {
            ...
            case 500:
                if (strpos(strtolower((string) $response->getBody()), 'longer than 2000 characters') !== false ||
                    ...
                    // Response was longer than 2000 characters and was blocked by Lemuria.
    ...
    {
        return 'LemuriaBot (https://github.com/VZGCoders/lemuria-bot, '.self::VERSION.')';
    }
}