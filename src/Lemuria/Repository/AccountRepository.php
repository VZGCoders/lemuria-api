...
use Lemuria\Http;
use Lemuria\Parts\Account\Account;
use Lemuria\Parts\Part;
use React\Promise\ExtendedPromiseInterface;

/**
 * Contains all Accounts in Lemuria.
 *
 * @see \Lemuria\Parts\Account\Account
 *
...
class AccountRepository extends AbstractRepository
{
	...
	*/
    ...
    public function new($discord_id = null): string
    {
		...
		if ($part = $this->factory->lemuria->factory(\Lemuria\Parts\Account\Account::class, [
			'id' => $snowflake,
