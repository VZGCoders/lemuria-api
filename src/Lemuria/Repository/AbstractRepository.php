...
use Lemuria\Helpers\Collection;
...
/**
 * Repositories provide a way to store and update parts on the Lemuria server.
 *
 ...
 abstract class AbstractRepository extends Collection
{
    ...
    /**
     * Endpoints for interacting with the Lemuria servers.
     *
     * @var array Endpoints.
     */
    protected $endpoints = [];
    ...
    public function __construct(Http $http, Factory $factory, array $vars = [])
    {
        ...
        $this->vars = $vars;
		$this->browser = $factory->lemuria->browser;
