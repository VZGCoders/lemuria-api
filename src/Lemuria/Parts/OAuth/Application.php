...
namespace Lemuria\Parts\OAuth;

use Lemuria\Parts\Part;
use Lemuria\Parts\Permissions\Permission;
...
class Application extends Part
{
    ...
    public function getInviteURLAttribute($permissions = 0): string
    {
        ...
        return "https://lemuria.valzargaming.com/oauth2/authorize?client_id={$this->id}&scope=bot&permissions={$permissions}";
    }
}
