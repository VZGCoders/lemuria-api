...
abstract class Part implements ArrayAccess, JsonSerializable
{
    ...
    /**
     * Is the part already created in the Lemuria servers?
     *
     ...
     */
    public function __construct(Lemuria $lemuria, array $attributes = [], bool $created = false)
    {
        $this->lemuria = $lemuria;
        $this->factory = $lemuria->getFactory();
		$this->http = $lemuria->getHttpClient();
     ...
     * the part from Lemuria's servers.
     *
    ...
    {
        $str = $type.\Lemuria\studly($key).'Attribute';
