...
$rescue = \Lemuria\VarLoad("_globals", "RESCUE.php"); //Check if recovering from a fatal crash
if ($rescue == true) { //Attempt to restore crashed session
	...
	foreach ($rescue_vars as $var) {
		$backup_var = \Lemuria\VarLoad("_globals", "$var");
	...
	\Lemuria\VarSave("_globals", "rescue.php", false);
